						...
						if ( isset ($_POST['BtnEnviar']) )
						{
							...
							if (mysqli_num_rows($querybuscarU) > 0 )
							{
								...
								while (($fila=mysqli_fetch_array($querybuscarU)))
								{
									...
									echo "<td><a href='modificar.php?id=$id'><img src='image/editar.png' tittle='Modificar'></a></td>";
									echo "<td><a href='eliminar.php?id=$id'><img src='image/eliminar.png' tittle='Eliminar'></a></td>";
