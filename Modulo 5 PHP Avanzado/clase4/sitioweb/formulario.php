				...
				<article>
					...
					<fieldset>
						...
						if ( isset ($_POST['BtnEnviar']) )
						{
								...
								{
									// Buscar en la Base de Datos
									$querybuscar = $mysqli->query("SELECT * FROM datospersonales join usuario on datospersonales.id = usuario.id where cedula='$cedula' or usuario='$usuario' ") or die ( "<br>No se puede ejecutar query para buscar datos ". $mysqli->error);
