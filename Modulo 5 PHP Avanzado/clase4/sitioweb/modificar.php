				...
				<article>
					...
					<fieldset>
						...
						echo "<label>Repetir Clave :
								<input name='txtclave2' type='text' id='txtclave2' size='30' maxlength='20' 
						...
						if ( isset ($_POST['BtnEnviar']) )
						{
							...
							else
							{
								...
								$queryUpdate = $mysqli->query("UPDATE datospersonales SET nombre='$nombre',
								 apellido='$apellido', genero='$RadOpcion', edocivil='$Seleccion', fechanac='$fechanac',
								 correo='$correo' where id='$id'") or die 
								("<br>No se puede ejecutar query para modificar datos personales". $mysqli->error);

								$queryUpdate2 = $mysqli->query("UPDATE usuario SET usuario='$usuario',
								 clave='$clave' where id='$id'") or die 
								("<br>No se puede ejecutar query para modificar datos usuario". $mysqli->error);
