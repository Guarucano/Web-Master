			...
			<div id="caja2">
				<article>
					...
					<fieldset>
						...
						<?php
						echo "<label>Nombre :
								<input name='txtnombre' type='text' id='txtnombre' size='30' maxlength='20' disabled placeholder='ingrese nombre' value='$nombre'>
						</label>";
						?>
						<?php
						...
						<?php
						echo "<label>Apellido :
								<input name='txtapellido' type='text' id='txtapellido' size='30' maxlength='20' disabled placeholder='ingrese apellido' value='$apellido'>
						</label>";
						?>
						<?php
						// el isset determina si una variable está definida, es decir posee algún valor, en cuyo caso nos devolvera el valor booleano.
						...
						// Validacion de Radiobox
							...
							echo "<input name='RadOpcion' disabled  type='radio' id='RadOpcion' value='F' ";
								if($RadOpcion === 'F')
								{
								  echo "checked ";
								}
							...
							echo "<input name='RadOpcion' disabled  type='radio' id='RadOpcion' value='M' ";
								if($RadOpcion === 'M')
								{
								  echo "checked ";
								}
						...
						<?php
						 ...
						 echo	"<label>Hobies : </label> <br />  ";
							...
							while (($fila=mysqli_fetch_array($querybuscarH)))
							{
								...
								echo "$nombrehobie : <input name='CheckBox[]'  type='checkbox' disabled value='$idhobie' ";
						...
						// Validad Seleccion en Php
							echo	"<label><br />Estado Civil : </label> <br />
								<select name='seleccion_simple' disabled >
						...
						<?php
						echo "<label>fechanac :
								<input name='txtfechanac' type='date' id='txtfechanac' size='12' maxlength='8' disabled  placeholder='ingrese fecha nac.' value='$fechanac'>
						</label>";
						...
						<?php
						echo "<label>correo :
								<input name='txtcorreo' type='email' id='txtcorreo' size='80' maxlength='80' disabled placeholder='ingrese correo electrónico' value='$correo'>
						</label>";
						...
						echo "<label>Nombre de Usuario :
								<input name='txtusuario' type='text' id='txtusuario' size='30' maxlength='20' disabled  placeholder='ingrese el usuario' value='$usuario'>
						</label>";
						?>
						<?php
						// el isset determina si una variable está definida, es decir posee algún valor, en cuyo caso nos devolvera el valor booleano.
						...
						<?php
						echo "<label>Clave :
								<input name='txtclave1' type='text' id='txtclave1' size='30' maxlength='20'  disabled placeholder='ingrese la clave' value='$clave'>
						</label>";
						?>
						<?php
						// el isset determina si una variable está definida, es decir posee algún valor, en cuyo caso nos devolvera el valor booleano.
						...
						echo "<label>Repetir Clave :
								<input name='txtclave2' type='text' id='txtclave2' size='30' maxlength='20' disabled placeholder='ingrese la clave' ";
								if (isset($_POST['BtnEnviar'])) 
								{
									echo "value='$clave2'>";
								}else
						...
						if ( isset ($_POST['BtnEnviar']) )
						{
							...
							{
								$queryEliminar = $mysqli->query("DELETE from datospersonales where id='$id'") or die ( "<br>No se puede ejecutar query para eliminar datos p ". $mysqli->error);

								$queryEliminar2 = $mysqli->query("DELETE from usuario where id='$id'") or die ( "<br>No se puede ejecutar query para eliminar usuario ". $mysqli->error);

								$queryEliminar3 = $mysqli->query("DELETE from hobiesdp where id='$id'") or die ( "<br>No se puede ejecutar query para eliminar datos hobies ". $mysqli->error);		
