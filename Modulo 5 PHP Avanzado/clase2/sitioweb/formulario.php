			...
			<div id="caja2">
				<article>
					...
					<fieldset>
						...
						<?php
						echo "<label>Usuario :
								<input name='txtusuario' type='text' id='txtusuario' size='30' maxlength='20' placeholder='ingrese usuario' value='$usuario'>
						</label>";
						?>
						<?php
						// el isset determina si una variable está definida, es decir posee algún valor, en cuyo caso nos devolvera el valor booleano.
						...
						<?php
						echo "<label>Clave :
								<input name='txtclave1' type='password' id='txtclave1' size='30' maxlength='20' placeholder='ingrese clave' value='$clave'>
						</label>";
						...
						<?php
						echo "<label>Repetir clave2 :
								<input name='txtclave2' type='password' id='txtclave2' size='30' maxlength='20' placeholder='ingrese clave' value='$clave2'>
						</label>";
						...
						if ( isset ($_POST['BtnEnviar']) )
						{
								...
								else
								{
									...
									// validar datos unicos con cedula
									...
									{
										echo "<span class='error'><br><br>Datos ya registrados<br><br></span>";
										echo "<br /><br /><label><input name='BtnEnviar' type='submit' id='BtnEnviar' value='Enviar' /></label>";
									}
									else
									{
