			...
			<h1>FORMULARIO DE REGISTRO</h1>
				<form action="modules/registro.php" method="post" id="form">
					<div class="form-group">
						...
						<input type="number" min="4" class="form-control" id="coda"
						name = "profe">
						<label for="">Teléfono</label>
						<input type="number" min="7" class="form-control" id="telef"
						name = "profe">
						<br><br>
		...
		$(document).ready(function(){
			$("#form2").submit(function(e){
				...
				$.ajax({
					...
					function(data){
						console.log(data.idTe);
						console.log(data.cod_area);
						console.log(data.numero);
						console.log(data.Personas_cedula);						
					}
				).fail(
					function(error){
